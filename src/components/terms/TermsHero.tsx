      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-display font-bold tracking-tight text-on-surface leading-[1.1] mb-6">
            Clear terms for <br />
            <span className="text-primary">using DialPulse.</span>
          </h1>

          {/* Supporting Copy */}
          <p className="text-lg sm:text-xl text-on-surface-variant leading-relaxed max-w-3xl mb-8">
            These Terms govern access to and use of the DialPulse platform. They are written to make the responsibilities of DialPulse and its customers easier to understand.
          </p>
          ...
          <div className="p-4 sm:p-5 rounded-2xl bg-surface-container border border-outline-variant/80 flex items-start gap-3.5 max-w-3xl">
            ...
            <div className="text-xs sm:text-sm text-on-surface-variant leading-relaxed">
              <strong className="text-on-surface font-semibold">Pre-Publication Status Notice:</strong> This document represents an engineering-aligned draft reflecting verified product scope, access boundaries, and operational capabilities. Commercial liability terms, legal entity assignments, governing jurisdiction, and statutory warranties are explicitly marked as <span className="font-mono text-amber-800 bg-amber-100/60 px-1 py-0.5 rounded">To be confirmed</span> or <span className="font-mono text-amber-800 bg-amber-100/60 px-1 py-0.5 rounded">Pending legal review</span>.
            </div>
          </div>
        </div>
      </div>

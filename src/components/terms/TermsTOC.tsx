...
export const TERMS_SECTIONS: TOCSection[] = [
  { id: 'acceptance-of-terms', number: '01', label: 'Acceptance of Terms' },
  { id: 'eligibility-and-authority', number: '02', label: 'Eligibility and Authority' },
  { id: 'the-dialpulse-service', number: '03', label: 'The DialPulse Service' },
  { id: 'accounts-and-access', number: '04', label: 'Accounts and Access' },
  { id: 'customer-data', number: '05', label: 'Customer Data' },
  { id: 'customer-responsibilities', number: '06', label: 'Customer Responsibilities' },
  { id: 'acceptable-use', number: '07', label: 'Acceptable Use' },
  { id: 'communication-and-compliance-responsibilities', number: '08', label: 'Communication & Compliance' },
  { id: 'ai-assisted-features', number: '09', label: 'AI-Assisted Features' },
  { id: 'third-party-services', number: '10', label: 'Third-Party Services' },
  { id: 'imports-exports-customer-content', number: '11', label: 'Imports, Exports & Content' },
  { id: 'security', number: '12', label: 'Security & Safeguards' },
  { id: 'intellectual-property', number: '13', label: 'Intellectual Property' },
  { id: 'fees-and-commercial-terms', number: '14', label: 'Fees & Commercial Terms' },
  { id: 'service-availability-and-changes', number: '15', label: 'Availability & Changes' },
  { id: 'suspension-and-termination', number: '16', label: 'Suspension & Termination' },
  { id: 'disclaimers', number: '17', label: 'Disclaimers' },
  { id: 'limitation-of-liability', number: '18', label: 'Limitation of Liability' },
  { id: 'indemnification', number: '19', label: 'Indemnification' },
  { id: 'confidentiality', number: '20', label: 'Confidentiality' },
  { id: 'governing-law-and-disputes', number: '21', label: 'Governing Law & Disputes' },
  { id: 'changes-and-contact', number: '22', label: 'Changes & Contact' },
];
...
export function TermsTOC() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      let currentActive = TERMS_SECTIONS[0].id;
  ...
  const activeSection = TERMS_SECTIONS.find((s) => s.id === activeId) || TERMS_SECTIONS[0];
      ...
      <aside className="hidden lg:block w-72 shrink-0">
        <div className="sticky top-24 max-h-[calc(100vh-7rem)] overflow-y-auto pr-4 py-2 scrollbar-thin">
          ...
          <div className="mt-8 p-3.5 rounded-xl bg-surface-container-low border border-outline-variant/70 text-[11px] text-on-surface-variant leading-relaxed">
            <span className="font-semibold text-on-surface block mb-1">Status: Pre-Publication Draft</span>
            Technical specifications verified. Legal and commercial provisions pending legal review.
          </div>
        </div>
      </aside>
    </>
